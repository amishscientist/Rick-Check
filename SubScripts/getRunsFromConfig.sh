...
if [[ "${BASH_SOURCE[0]}" = "$0" ]]; then
   ...
   $simName ./RUN_test/input.py -OO ./The_Rick_Pit_And_Resort/RUN_Rick_$1 >& ./The_Rick_Pit_And_Resort/output.$1.out.out
   exitCode=$? 
   echo $exitCode > ./The_Rick_Pit_And_Resort/RUN_Rick_$1/exitCode.out.out
